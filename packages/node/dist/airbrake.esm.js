...
var RouteMetric = /** @class */ (function (_super) {
    ...
    RouteMetric.prototype.end = function (endTime) {
        if (!this.endTime) {
...
var Scope$1 = /** @class */ (function (_super) {
    __extends(Scope, _super);
    function Scope() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this._noopMetric = new NoopMetric();
        return _this;
    }
    Scope.prototype.clone = function () {
        var clone = new Scope();
    ...
    Scope.prototype.metric = function () {
        return this._metric || this._noopMetric;
    };
    Scope.prototype.setMetric = function (metric) {
        this._metric = metric;
    };
    return Scope;
}(Scope));
