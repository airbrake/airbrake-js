...
Obtainer = require("../../../src/util/source_map_obtainer")
...
describe "SourcemapsObtainer", ->
  ...
  describe ".sourceMapUrl", ->
    it "recognizes //# style source map urls", ->
      url = obtainer._sourceMapUrl("//# sourceMappingURL=/test/examples/js/uglify/bundle.js.map")
  ...
  describe ".dataUri", ->
    it "decodes Base64-encoded data uris", ->
      decoded = obtainer._dataUri("//@ sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJmaWxlIjoidGVzdC9leGFtcGxlcy9qcy91Z2xpZnkvYnVuZGxlLmpzIiwic291cmNlcyI6WyJ0ZXN0L2V4YW1wbGVzL2pzL3VnbGlmeS9tYWluLmpzIl0sIm5hbWVzIjpbIkVycm9yTWFrZXIiXSwibWFwcGluZ3MiOiJBQUVBLFFBQVNBLGNBQ1AifQ==")
